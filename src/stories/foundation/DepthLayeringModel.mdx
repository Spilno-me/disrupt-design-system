...
<div style={{
  ...
  <table style={{
    ...
    <tbody>
      {[
        { distance: 'Closest', layer: 'Elevated', light: { name: 'softLinen', color: PRIMITIVES.softLinen }, dark: { name: 'ABYSS[400]', color: ABYSS[400] }, use: 'Modals, dropdowns, tooltips' },
        { distance: '', layer: 'Card', light: { name: 'softLinen', color: PRIMITIVES.softLinen }, dark: { name: 'ABYSS[500]', color: ABYSS[500] }, use: 'Cards, panels' },
        { distance: '', layer: 'Surface', light: { name: 'softLinen', color: PRIMITIVES.softLinen }, dark: { name: 'ABYSS[700]', color: ABYSS[700] }, use: 'Content areas, sidebars' },
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ fontSize: TYPOGRAPHY.fontSize.xs[0], color: ABYSS[500], marginTop: SPACING.px.tight }}>Card (softLinen)</div>
        </div>

        <div style={{ fontSize: TYPOGRAPHY.fontSize.xs[0], color: ABYSS[500], textAlign: 'center' }}>Surface (softLinen)</div>
      </div>
    </div>
  ...
  <div style={{
    ...
    <div style={{ textAlign: 'center' }}>
      ...
      <div style={{ display: 'flex', gap: SPACING.px.micro }}>
        {[PRIMITIVES.softLinen, PRIMITIVES.softLinen, PRIMITIVES.cream, SLATE[100]].map((color, idx) => (
          <div key={idx} style={{
            width: '40px',
            height: `${40 + idx * 20}px`,
            background: color,
...
<div style={{
  ...
  <table style={{
    ...
    <tbody>
      {[
        { depth: 1, token: 'background.elevated', light: 'softLinen', lightColor: PRIMITIVES.softLinen, dark: 'ABYSS[400]', darkColor: ABYSS[400] },
        { depth: 2, token: 'background.surface', light: 'softLinen', lightColor: PRIMITIVES.softLinen, dark: 'ABYSS[700]', darkColor: ABYSS[700] },
        { depth: 3, token: 'background.surfaceHover', light: 'SLATE[100]', lightColor: SLATE[100], dark: 'ABYSS[600]', darkColor: ABYSS[600] },
        { depth: 4, token: 'background.surfaceActive', light: 'SLATE[200]', lightColor: SLATE[200], dark: 'ABYSS[500]', darkColor: ABYSS[500] },
        { depth: 5, token: 'background.page', light: 'cream', lightColor: PRIMITIVES.cream, dark: 'ABYSS[900]', darkColor: ABYSS[900] },
      ].map((row) => (
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>1. Elevated → <span style={{ color: DEEP_CURRENT[600] }}>softLinen</span></div>
        <div>2. Card → <span style={{ color: DEEP_CURRENT[600] }}>softLinen</span></div>
        <div>3. Surface → <span style={{ color: DEEP_CURRENT[600] }}>softLinen</span></div>
