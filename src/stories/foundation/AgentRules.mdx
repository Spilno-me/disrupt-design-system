...
<div style={{
  ...
  <h3 style={{ marginTop: 0, marginBottom: SPACING.px.base, color: ABYSS[800], display: 'flex', alignItems: 'center', gap: SPACING.px.tight }}>
    <BookOpen size={18} color={ABYSS[600]} /> Table of Contents
  </h3>
  <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: SPACING.px.tight }}>
    <span>• <a href="#clean-code">Clean Code Rules</a></span>
    <span>• <a href="#component-dev">Component Development</a></span>
    <span>• <a href="#ux-laws">UX Laws</a></span>
    <span>• <a href="#defensive">Defensive Components</a></span>
    <span>• <a href="#styling">Styling & Tokens</a></span>
    <span>• <a href="#spacing">Spacing Rules</a></span>
    <span>• <a href="#storybook">Storybook Rules</a></span>
    <span>• <a href="#lessons">Lessons Learned</a></span>
    <span>• <a href="#hookify">Hookify Enforcement</a></span>
  </div>
</div>
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: SPACING.px.base, marginBottom: SPACING.px.comfortable }}>
  ...
  <FeatureCard
    icon={<Zap size={20} />}
    title="Hick's Law"
    description="Decision time ∝ options. Maximum 5-7 options before cognitive overload."
    color={HARBOR[500]}
  />
  <FeatureCard
    icon={<Layers size={20} />}
    title="Miller's Law"
    description="Working memory holds 7±2 items. Chunk information into groups."
    color={DUSK_REEF[500]}
  />
  <FeatureCard
    icon={<Zap size={20} />}
  ...
  <table style={{ width: '100%', marginTop: SPACING.px.base, borderCollapse: 'collapse', fontSize: TYPOGRAPHY.fontSize.sm }}>
    ...
    <tbody>
      <tr style={{ borderBottom: `1px solid ${ABYSS[100]}` }}>
        ...
        <td style={{ padding: SPACING.px.tight, color: CORAL[600] }}>❌ Trust props</td>
      </tr>
      <tr style={{ borderBottom: `1px solid ${ABYSS[100]}` }}>
      ...
      <tr>
        ...
        <td style={{ padding: SPACING.px.tight, color: HARBOR[600], fontWeight: 600 }}>✅ Validate here</td>
      </tr>
    </tbody>
  </table>
</div>
  ...
  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: TYPOGRAPHY.fontSize.sm }}>
    ...
    <tbody>
      <tr style={{ borderBottom: `1px solid ${SLATE[100]}` }}>
        ...
        <td style={{ padding: SPACING.px.tight }}>Icon↔text</td>
      </tr>
      <tr style={{ borderBottom: `1px solid ${SLATE[100]}` }}>
        ...
        <td style={{ padding: SPACING.px.tight }}>Label↔input</td>
      </tr>
      <tr style={{ borderBottom: `1px solid ${SLATE[100]}` }}>
