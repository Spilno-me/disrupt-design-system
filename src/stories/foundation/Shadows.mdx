...
<div style={{
  ...
  <div style={{
    ...
    <Layers size={180} color={PRIMITIVES.white} strokeWidth={1} />
  </div>

  {/* Light source indicator */}
  <div style={{
    position: 'absolute',
    top: SPACING.px.comfortable,
    right: SPACING.px.spacious,
    width: '60px',
    height: '60px',
  ...
  <div style={{ position: 'relative', zIndex: 1 }}>
    ...
    <p style={{
      ...
      <span>Natural light physics for elevation and visual hierarchy.
      Shadows communicate depth, importance, and interactivity.</span>
    </p>
  </div>
</div>
...
<h2 style={{ marginTop: SPACING.px.sectionHeadingTop, marginBottom: SPACING.px.sectionHeadingBottom }}>The Physics of Shadows</h2>
...
<h2 style={{ marginTop: SPACING.px.sectionHeadingTop, marginBottom: SPACING.px.sectionHeadingBottom }}>CSS Anatomy</h2>
...
<h2 style={{ marginTop: SPACING.px.sectionHeadingTop, marginBottom: SPACING.px.sectionHeadingBottom }}>Special Purpose Shadows</h2>
