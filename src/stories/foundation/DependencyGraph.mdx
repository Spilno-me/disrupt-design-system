...
<div style={{
  ...
  <div style={{ position: 'relative', zIndex: 1 }}>
    <div style={{
      ...
      <Network size={14} color={DEEP_CURRENT[300]} />
      <span style={{
        fontSize: '12px',
        fontWeight: 600,
    ...
    <p style={{
      ...
      <span>Explore the complete token architecture from raw hex values to components.
      See how primitives (ABYSS, DEEP_CURRENT, etc.) flow through aliases to components—each node shows its actual color!</span>
    </p>
  </div>
</div>
