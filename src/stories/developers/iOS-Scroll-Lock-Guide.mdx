...
# iOS Safari Scroll Lock Guide

Prevent body scroll leaking through modals and overlays on iOS Safari. Implementation of the proven **StripeArmy technique** for complete scroll isolation.
