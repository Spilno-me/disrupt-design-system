...
<div style={{
  ...
  {[
    ...
    { name: 'get_design_philosophy', icon: <BookOpen size={20} />, desc: 'Wu Wei principles and rules', example: 'get_design_philosophy({})' },
  ].map((tool) => (
    <div
      key={tool.name}
      style={{
...
<div style={{
  ...
  <GuidelineCard type="do" title="Wu Wei Philosophy">
    Rules come to developers at the moment of creation. No need to memorize—AI guides toward correct patterns.
  </GuidelineCard>
