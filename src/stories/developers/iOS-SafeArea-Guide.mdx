...
import { Home, Bell, Settings, Menu, User, Search } from 'lucide-react';

<Meta title="Developers/iOS Safe Area Guide" />

# iOS Safe Area & Dynamic Island Design Guide

This guide covers best practices for designing UI that respects iOS safe areas, particularly the **Dynamic Island** introduced with iPhone 14 Pro. Updated for **iOS 26 / Safari 26** (WWDC25).
