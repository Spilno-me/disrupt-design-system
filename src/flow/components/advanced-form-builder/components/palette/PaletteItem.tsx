...
> = {
  // Abyss/Purple for Layout & Structure
  layout: {
    iconBg: 'bg-[var(--brand-abyss-100)] dark:bg-[var(--brand-abyss-900)]',
    iconText: 'text-[var(--brand-abyss-600)] dark:text-[var(--brand-abyss-300)]',
    hoverBg: 'hover:bg-[var(--brand-abyss-50)]/50 dark:hover:bg-[var(--brand-abyss-900)]/20',
  },
