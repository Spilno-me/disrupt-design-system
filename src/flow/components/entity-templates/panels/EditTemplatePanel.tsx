/**
 * EditTemplatePanel - Non-modal slide-in panel for editing entity templates
 *
 * Uses Sheet component for a contextual editing experience that doesn't
 * block the main page. Maintains visibility of the template list while editing.
 *
 * @example
 * ```tsx
 * <EditTemplatePanel
...
import type { EditTemplatePanelProps, EditTemplateFormData } from '../types'
import { validateTemplateName } from '../types'

// Re-export for convenience
export type { EditTemplatePanelProps }
...
export function EditTemplatePanel({
  template,
  open,
  onOpenChange,
  onSubmit,
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <SheetHeader className="flex-shrink-0 p-6 pb-4 border-b border-default">
            ...
            <div className="flex items-start gap-3 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                ...
                <SheetDescription className="mt-1">
                  Modify template configuration and schema definition
                </SheetDescription>
              </div>
            </div>
            <Button
        ...
        >
          <div className="flex-1 min-h-0 overflow-y-auto p-6 space-y-4">
            ...
            <div className="rounded-lg border border-default p-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-center gap-1">
                    <Label htmlFor="panel-business-key">Business Key</Label>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          type="button"
          ...
          {/* Footer */}
          <SheetFooter className="flex-shrink-0 p-6 pt-4 border-t border-default">
...
EditTemplatePanel.displayName = 'EditTemplatePanel'
