...
export const Transparent: Story = {
  ...
  decorators: [
    (Story) => (
      <div className="bg-page min-h-[100px]">
        <Story />
      </div>
    ),
  ],
  ...
  args: {
    leftContent: (
      <div className="flex items-center gap-2">
        <span className="text-xs sm:text-sm font-medium text-primary">Made with ❤️ by</span>
        <a href="#" className="text-accent text-xs sm:text-sm font-bold hover:underline">
          Our Team
        </a>
      </div>
    ),
  ...
  args: {
    ...
    rightContent: (
      <div className="flex items-center gap-6">
        <a href="#" className="text-primary hover:text-accent text-xs sm:text-sm">
          Support
        </a>
        <a href="#" className="text-primary hover:text-accent text-xs sm:text-sm">
          Documentation
