...
export const LargeDataset: Story = {
  args: {
    leads: Array.from({ length: 100 }, (_, i) => ({
      ...
      status: ['new', 'in_progress', 'converted', 'lost'][Math.floor(Math.random() * 4)] as Lead['status'],
...
export const MixedStatuses: Story = {
  args: {
    leads: [
      ...
      { ...sampleLeads[1], id: '2b', status: 'in_progress', priority: 'medium', score: 75 },
      { ...sampleLeads[2], id: '3b', status: 'in_progress', priority: 'low', score: 60 },
