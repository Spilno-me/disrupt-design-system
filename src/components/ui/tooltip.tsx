...
/** Z-index for tooltip overlay layer - above most content but below modals */
  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // Dark background with light text for high contrast (DDS semantic tokens)
      ...
      >
        ...
        <TooltipPrimitive.Arrow
          style={{ zIndex: TOOLTIP_Z_INDEX }}
          className="bg-inverse-bg fill-inverse-bg size-2.5 translate-y-[calc(-50%_-_2px)] rotate-45 rounded-[2px]"
        />
      </TooltipPrimitive.Content>
    </TooltipPrimitive.Portal>
  )
