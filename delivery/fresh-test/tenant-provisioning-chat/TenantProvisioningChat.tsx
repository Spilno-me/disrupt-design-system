...
// =============================================================================
// DESIGN TOKENS (Inlined for standalone delivery)
// =============================================================================
      ...
      >
        ...
        <div className="flex items-center justify-between px-4 py-3" style={{ backgroundColor: ALIAS.background.surface, borderBottom: `1px solid ${SLATE[200]}` }}>
          <div className="flex items-center gap-3">
            {onCancel && (
              <button onClick={handleBack} className="p-1.5 rounded-lg transition-colors hover:bg-gray-100" title="Exit">
          ...
          {onSaveProgress && currentSectionIndex > 0 && !isComplete && (
            <button
              ...
              className="flex items-center gap-1.5 px-3 py-1.5 text-xs font-medium rounded-lg transition-colors hover:bg-gray-100"
