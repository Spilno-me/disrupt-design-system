...
// Inlined design tokens
const ACCENT_STRONG = '#08A4BD' // Teal brand color
const ACCENT_DARK = '#068397'   // Darker teal for border
...
export interface SliderProps extends Omit<React.ComponentProps<"div">, "onChange"> {
  ...
  /** Label text */
  label?: string
  /** Unit text displayed after value */
  unit?: string
...
/**
 * Slider - Customizable range slider built on Radix UI
 *
 * NOTE: This uses a simplified API compared to shadcn/ui:
 * - value: number (not number[])
 * - onChange: (value: number) => void (not onValueChange)
 */
